...
const BASE   = 'D:\\TheDarkCUp';
const CHROME = 'C:\\Program Files\\Google\\Chrome\\Application\\chrome.exe';
const TMP    = resolve(BASE, '.yorvath-tmp.html');
...
console.log('Fonts ready. Building HTML...');
...
/* PARCHMENT
   ...
   backgrounds of the two dark pages, so it never bleeds through them. */
.page-bg {
...
/* COVER
   Composed in three bands (mark, name, epigraph) so the page reads as a
   designed title page instead of a cluster floating in the middle. */
.cover {
  width: 210mm; height: 297mm;
  background: #0c0b09;
...
const SIGIL_SVG = `<svg viewBox="0 0 200 200" width="152" height="152" xmlns="http://www.w3.org/2000/svg">
  <defs>
  ...
  <line x1="100" y1="14"  x2="100" y2="8"   stroke="#9aa1a8" stroke-width="1.5" stroke-linecap="round"/>
  <line x1="143" y1="25"  x2="146" y2="20"  stroke="#9aa1a8" stroke-width="1.5" stroke-linecap="round"/>
  <line x1="175" y1="57"  x2="180" y2="54"  stroke="#9aa1a8" stroke-width="1.5" stroke-linecap="round"/>
  <line x1="186" y1="100" x2="192" y2="100" stroke="#9aa1a8" stroke-width="1.5" stroke-linecap="round"/>
  <line x1="175" y1="143" x2="180" y2="146" stroke="#9aa1a8" stroke-width="1.5" stroke-linecap="round"/>
  <line x1="143" y1="175" x2="146" y2="180" stroke="#9aa1a8" stroke-width="1.5" stroke-linecap="round"/>
  <line x1="100" y1="186" x2="100" y2="192" stroke="#9aa1a8" stroke-width="1.5" stroke-linecap="round"/>
  <line x1="57"  y1="175" x2="54"  y2="180" stroke="#9aa1a8" stroke-width="1.5" stroke-linecap="round"/>
  <line x1="25"  y1="143" x2="20"  y2="146" stroke="#9aa1a8" stroke-width="1.5" stroke-linecap="round"/>
  <line x1="14"  y1="100" x2="8"   y2="100" stroke="#9aa1a8" stroke-width="1.5" stroke-linecap="round"/>
  <line x1="25"  y1="57"  x2="20"  y2="54"  stroke="#9aa1a8" stroke-width="1.5" stroke-linecap="round"/>
  <line x1="57"  y1="25"  x2="54"  y2="20"  stroke="#9aa1a8" stroke-width="1.5" stroke-linecap="round"/>
  <use href="#fa"/>
  <use href="#fa" transform="rotate(60,100,100)"/>
  <use href="#fa" transform="rotate(120,100,100)"/>
  <use href="#fa" transform="rotate(180,100,100)"/>
  <use href="#fa" transform="rotate(240,100,100)"/>
  <use href="#fa" transform="rotate(300,100,100)"/>
  <text font-family="serif" font-size="6.5" letter-spacing="3.5" fill="#6f8794">
    <textPath href="#rpath" startOffset="12%">VOLKIHAR · INNER COURT · 4E 185 ·</textPath>
  </text>
